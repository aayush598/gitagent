...
\subsubsection*{The Existing MIME Mapping (Not Used for Upload Validation)}
...
\subsubsection*{The Attack Surface}
...
\subsubsection*{What Should Happen}
...
\subsubsection*{Option A: Implement MIME Type Validation on Upload (Recommended)}
...
\subsubsection*{Option B: Extension Allowlist Only (Simpler)}
...
\subsubsection*{Option C: Content Security Scan with \texttt{libmagic} or \texttt{file-type}}
