...
\subsubsection*{The Three Consequences}
...
\subsubsection*{Why This Is High Severity}
...
\subsubsection*{Option A: Atomic Rollback (Recommended)}
...
\subsubsection*{Option B: Atomic Temp-File Write}
...
\subsubsection*{Option C: Use \texttt{execFile} to Prevent Shell Injection in Commit Message}
