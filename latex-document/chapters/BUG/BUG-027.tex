...
\subsubsection*{How It Is Called}
...
\subsubsection*{Why This Is a Vulnerability}
...
\subsubsection*{Comparison with SEC-001}
...
\subsubsection*{Option A: Use \texttt{execFileSync} Instead of \texttt{execSync} (Recommended)}
...
\subsubsection*{Option B: Validate and Sanitize the Directory Path}
...
\subsubsection*{Option C: Check Directory Existence First with \texttt{fs.stat}}
