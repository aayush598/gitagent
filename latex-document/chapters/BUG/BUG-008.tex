...
\subsubsection*{Why the Leading \texttt{\n} in \texttt{archiveEntry} Is a Problem}
...
\subsubsection*{Option A: Newline-Aware Concatenation (Recommended)}
...
\subsubsection*{Option B: Use \texttt{trimEnd} and Template Literal}
