...
\subsubsection*{The Discovery Pipeline (No Cache)}
...
\subsubsection*{The Load Pipeline (No Cache)}
...
\subsubsection*{Option A: In-Memory Cache with TTL (Recommended)}
...
\subsubsection*{Option B: File-Content Hash-Based Cache}
...
\subsubsection*{Option C: Module-Level Singleton Cache for Programmatic Entry}
