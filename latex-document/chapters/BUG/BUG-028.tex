...
The \texttt{discoverAndLoadPlugins} function in \texttt{src/plugins.ts:311-367} performs a full directory scan every time it is called — scanning local (\texttt{<agent-dir>/plugins/}), global (\texttt{\textasciitilde{}/.gitclaw/plugins/}), and installed (\texttt{<agent-dir>/.gitagent/plugins/}) directories, parsing every \texttt{plugin.yaml} manifest, validating and loading each plugin. There is \textbf{zero caching} of discovered plugins, manifest metadata, or resolved configurations between invocations.
...
|---|---|---|---|
| \texttt{dirExists} (stat) × 3 | \textasciitilde{}3ms | \textasciitilde{}30ms | \textasciitilde{}60ms |
| \texttt{fileExists} (stat) | \textasciitilde{}1ms | \textasciitilde{}10ms | \textasciitilde{}20ms |
| \texttt{readFile} (plugin.yaml) | \textasciitilde{}2ms | \textasciitilde{}20ms | \textasciitilde{}40ms |
| \texttt{yaml.load} | \textasciitilde{}5ms | \textasciitilde{}50ms | \textasciitilde{}100ms |
| Validation + config | \textasciitilde{}2ms | \textasciitilde{}20ms | \textasciitilde{}40ms |
| Declarative tool loading | \textasciitilde{}10-50ms | \textasciitilde{}100-500ms | \textasciitilde{}200-1000ms |
| Programmatic entry import | \textasciitilde{}50-200ms | \textasciitilde{}500-2000ms | \textasciitilde{}1000-4000ms |
| \textbf{Total (estimated)} | \textbf{\textasciitilde{}70-260ms} | \textbf{\textasciitilde{}700-2600ms} | \textbf{\textasciitilde{}1400-5200ms} |
