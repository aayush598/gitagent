...
\subsubsection*{The Two Rejection Points}
...
\subsubsection*{Option A: Cron Alias Expansion (Recommended)}
...
\subsubsection*{Option B: Support \texttt{@every N (seconds|minutes|hours)} Syntax}
