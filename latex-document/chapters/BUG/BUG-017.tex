...
\subsubsection*{The Shell Redirection Anatomy}
...
\subsubsection*{The Two Failure Points}
...
\subsubsection*{Option A: Remove \texttt{|| true} and Log Stderr (Recommended)}
...
\subsubsection*{Option B: Use \texttt{execFile} for Shell-Injection Safety}
