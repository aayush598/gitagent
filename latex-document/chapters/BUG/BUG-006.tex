...
\subsubsection*{The \texttt{dim} Function}
...
\subsubsection*{The Three Problems}
...
\subsubsection*{Option A: Validate with Throw and Error Aggregation}
...
\subsubsection*{Option B: Fail-Stop on Invalid Schedule}
